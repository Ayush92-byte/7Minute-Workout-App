...
import com.ayushkushwaha2212.a7minutesworkout.databinding.ActivityBmiBinding
...
class BMIActivity : AppCompatActivity() {
    ...
    private var currentVisibleView: String =
        METRIC_UNITS_VIEW // A variable to hold a value to make a selected visible
    ...
    private fun displayBMIResult(bmi:Float){
        ...
        if(bmi.compareTo(15f) <= 0){
            ...
            bmiDescription = "OMG! You are in a very dangerous conditions! Act now!"
        }else {
